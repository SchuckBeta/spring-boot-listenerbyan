# spring-boot-listenerbyan
spring-boot-listenerbyan  注解实现Spring 监听、观察者模式、事件驱动模型

![What](https://github.com/SchuckBeta/spring-boot-listener/blob/master/screenshots/listener1.png)

![What](https://github.com/SchuckBeta/spring-boot-listener/blob/master/screenshots/listener2.png)
